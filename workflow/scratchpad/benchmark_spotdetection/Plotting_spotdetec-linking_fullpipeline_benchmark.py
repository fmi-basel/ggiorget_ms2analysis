...
# trackpy data
filename_trackpy1 = '20230715_306KI-ddCTCF-dpuro-MS2-HaloMCP-E10Mobi_JF549_5G7_1_FullseqTIRF-mCherry-GFPCy5WithSMB_s1_cutMAX_summary_spotdet-filter_fullpipeline.csv'
filename_trackpy2 = '20230719_306KI-ddCTCF-dpuro-MS2-HaloMCP-E10Mobi_JF549_5E10_1_FullseqTIRF-mCherry-GFPCy5WithSMB_s1_MAX_summary_spotdet-filter_fullpipeline.csv'
filename_trackpy3 = '20230720_306KI-ddCTCF-dpuro-MS2-HaloMCP-E10Mobi_JF549_5F11_1_FullseqTIRF-mCherry-GFPCy5WithSMB_s5_MAX_summary_spotdet-filter_fullpipeline.csv'
...
df_trackpy['FDR_filtered'] = df_trackpy['FP_filtered'] / (df_trackpy['FP_filtered'] + df_trackpy['TP_filtered'])
df_trackpy['Precision_filtered'] = df_trackpy['TP_filtered'] / (df_trackpy['FP_filtered'] + df_trackpy['TP_filtered'])
df_trackpy['Sensitivity_filtered'] = df_trackpy['TP_filtered'] / (df_trackpy['FN_filtered'] + df_trackpy['TP_filtered'])
df_trackpy['F1score_filtered'] = 2 * df_trackpy['TP_filtered'] / (2 * df_trackpy['TP_filtered'] + df_trackpy['FP_filtered'] + df_trackpy['FN_filtered'])

# -- full pipeline no filter Plotting --
...
plt.tight_layout()
plt.show()
# plt.savefig(os.path.join(path, 'plots_spotdetection/fullpipeline-linking_TP_count.pdf'))
plt.close()
...
plt.tight_layout()
plt.show()
#plt.savefig(os.path.join(path, 'plot_benchmark_spotdetection/fiveclones/fullpipeline-linking_precision.pdf'))
plt.close()
...
plt.tight_layout()
plt.show()
#plt.savefig(os.path.join(path, 'plot_benchmark_spotdetection/fiveclones/fullpipeline-linking_sensitivity.pdf'))
plt.close()
...
plt.tight_layout()
plt.show()
#plt.savefig(os.path.join(path, 'plot_benchmark_spotdetection/fiveclones/fullpipeline-linking_f1.pdf'))
plt.close()
...
df_trackpy_pivot = df_trackpy_dia.pivot(index='threshold', columns='images', values='F1score')
...
plt.imshow(df_trackpy_pivot, cmap='viridis', aspect='auto', interpolation='none', vmin=0.05, vmax=0.75)
...
plt.tight_layout()
#plt.show()
plt.savefig(os.path.join(path, 'plots_benchmark_burstcalling/fiveclones/pipeline_F1score_heatmap.svg'), format='svg')
plt.close()
# -- full pipeline filter Plotting --
# For visualisation I look at rates independently dependent on the diameter in detection
# TP count
fig, axs = plt.subplots(len(projection), 1, figsize=(5, len(projection)*3), sharey=True)
for i, ax in enumerate(axs.ravel()):
    ax.bar(df_trackpy_dia[df_trackpy_dia['images'] == projection[i]]['threshold'].astype(str),
           df_trackpy_dia[df_trackpy_dia['images'] == projection[i]]['TP_filtered'])
    ax.set_title(f"{projection[i]}")
    ax.axhline(y=180, c='red', linestyle='dotted')
    ax.set_ylabel('True positive count')
ax.set_xlabel('threshold')
...
plt.tight_layout()
plt.show()
# plt.savefig(os.path.join(path, 'plots_spotdetection/fullpipeline-linking-filtered_TP_count.pdf'))
plt.close()
...
for i, ax in enumerate(axs.ravel()):
    ax.bar(df_trackpy_dia[df_trackpy_dia['images'] == projection[i]]['threshold'].astype(str),
           df_trackpy_dia[df_trackpy_dia['images'] == projection[i]]['Precision_filtered'])
    ax.set_title(f"{projection[i]}")
    ax.tick_params('x', labelrotation=45)
    # ax.axhline(y=0.95, c='red', linestyle='dotted')
    ax.set_ylabel('Precision')
...
plt.tight_layout()
plt.show()
#plt.savefig(os.path.join(path, 'plot_benchmark_spotdetection/fiveclones/fullpipeline-linking-filtered_precision.pdf'))
plt.close()
...
for i, ax in enumerate(axs.ravel()):
    ax.bar(df_trackpy_dia[df_trackpy_dia['images'] == projection[i]]['threshold'].astype(str),
           df_trackpy_dia[df_trackpy_dia['images'] == projection[i]]['Sensitivity_filtered'])
    ax.set_title(f"{projection[i]}")
    ax.tick_params('x', labelrotation=45)
    ax.set_ylabel('Sensitivity')
ax.set_xlabel('threshold')
...
plt.tight_layout()
plt.show()
#plt.savefig(os.path.join(path, 'plot_benchmark_spotdetection/fiveclones/fullpipeline-linking-filtered_sensitivity.pdf'))
plt.close()
...
for i, ax in enumerate(axs.ravel()):
    ax.bar(df_trackpy_dia[df_trackpy_dia['images'] == projection[i]]['threshold'].astype(str),
           df_trackpy_dia[df_trackpy_dia['images'] == projection[i]]['F1score_filtered'])
    ax.set_title(f"{projection[i]}")
    ax.tick_params('x', labelrotation=45)
    ax.set_ylabel('F1score')
ax.set_xlabel('threshold')
...
plt.tight_layout()
plt.show()
#plt.savefig(os.path.join(path, 'plot_benchmark_spotdetection/fiveclones/fullpipeline-linking-filtered_f1.pdf'))
plt.close()
...
df_trackpy_clone['Precision_filtered'] = df_trackpy_clone['TP_filtered'] / (df_trackpy_clone['FP_filtered'] + df_trackpy_clone['TP_filtered'])
df_trackpy_clone['Sensitivity_filtered'] = df_trackpy_clone['TP_filtered'] / (df_trackpy_clone['FN_filtered'] + df_trackpy_clone['TP_filtered'])
df_trackpy_clone['F1score_filtered'] = 2 * df_trackpy_clone['TP_filtered'] / (
            2 * df_trackpy_clone['TP_filtered'] + df_trackpy_clone['FP_filtered'] + df_trackpy_clone['FN_filtered'])
...
plt.tight_layout()
plt.show()
#plt.savefig(os.path.join(path, 'plot_benchmark_spotdetection/fiveclones/fullpipeline-linking_f1_clones.pdf'))
plt.close()
...
for i, ax in enumerate(axs.ravel()):
    ...
    ax.set_title(f"{projection[i]}")
    # ax.axhline(y=0.55, c='red', linestyle='dotted')
    ax.set_ylabel('F1score filtered')
    ax.set_xticks(df_trackpy_clone_dia[
                      (df_trackpy_clone_dia['images'] == projection[i]) & (df_trackpy_clone_dia['clone'] == clones[2])][
                      'threshold'])
ax.set_xlabel('threshold')
...
plt.tight_layout()
plt.show()
#plt.savefig(os.path.join(path, 'plot_benchmark_spotdetection/fiveclones/fullpipeline-linking-filtered_f1_clones.pdf'))
plt.close()
...
plt.tight_layout()
plt.show()
#plt.savefig(os.path.join(path, 'plot_benchmark_spotdetection/fiveclones/fullpipeline-linking_precision_clones.pdf'))
plt.close()
...
for i, ax in enumerate(axs.ravel()):
    ...
    ax.set_title(f"{projection[i]}")
    # ax.axhline(y=0.55, c='red', linestyle='dotted')
    ax.set_ylabel('Precision filtered')
    ax.set_xticks(df_trackpy_clone_dia[
                      (df_trackpy_clone_dia['images'] == projection[i]) & (df_trackpy_clone_dia['clone'] == clones[2])][
                      'threshold'])
ax.set_xlabel('threshold')
...
plt.tight_layout()
plt.show()
#plt.savefig(os.path.join(path, 'plot_benchmark_spotdetection/fiveclones/fullpipeline-linking-filtered_precision_clones.pdf'))
plt.close()
...
plt.tight_layout()
plt.show()
#plt.savefig(os.path.join(path, 'plot_benchmark_spotdetection/fiveclones/fullpipeline-linking_sensitivity_clones.pdf'))
plt.close()
...
for i, ax in enumerate(axs.ravel()):
    ...
    ax.set_title(f"{projection[i]}")
    # ax.axhline(y=0.55, c='red', linestyle='dotted')
    ax.set_ylabel('Sensitivity filtered')
    ax.set_xticks(df_trackpy_clone_dia[
                      (df_trackpy_clone_dia['images'] == projection[i]) & (df_trackpy_clone_dia['clone'] == clones[2])][
                      'threshold'])
ax.set_xlabel('threshold')
...
plt.tight_layout()
plt.show()
#plt.savefig(os.path.join(path, 'plot_benchmark_spotdetection/fiveclones/fullpipeline-linking-filtered_sensitivity_clones.pdf'))
plt.close()
